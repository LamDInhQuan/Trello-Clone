    ...
    board: {
        ...
        columns: [
            ...
            },
            {
                ...
                // phía FE tạo ra 1 card đặc biệt : PlaceHolder Card , không liên quan tới BackEnd
                // Card đặc biệt này được ẩn trên giao diện người dùng ( để tránh bug column rỗng khi 
                // kéo card )
                // Cấu trúc id card này là unique
                // "columnId-placeHolder-card" ( mỗi column chỉ có tối đa 1 card này )
                // Phải đầy đủ khi tạo : (_id , boardId , columnId , FE-PlaceHolderCard)
